...
const Component4 = () =>{
    ...
    const circle1 = (
        <circle
          cx={205/1536 * svgWidth} cy={70/722 * svgHeight}
          r={radius}
          fill="#C4C4C4"
        />
      );
      ...
      const circle2 = (
        <circle
          cx={1336/1536 * svgWidth} cy={380/722 * svgHeight}
          r={radius}
          fill="#C4C4C4"
        />
    );
    ...
    const circle3 = (
        <circle
          cx={205/1536 * svgWidth} cy={690/722 * svgHeight}
          r={radius}
          fill="#C4C4C4"
        />
      );
    ...
    const text = (
        <div className="text">
            <div className="lines">
                <div className="line-1">one stop solution to kickstart your journey <br/>
                in the world of <span> computer science</span></div>
                <div className="line-2">changing the<span> perspective </span>towards computers as it has  <br/>
                now become the backbone of world’s economy</div>
                <div className="line-3"><span>customizable curriculum </span> starting from basics to  <br/>
                 developing core understanding of the concepts</div>
            </div>
        </div>
    );
