...
const content1 = "We focus on developing core problem solving skills. These skills are highly in demand and critical for getting into the software industry."

const heading2 = "CODING APTITUDE";
const content2 = "Building an aptitude for the purpose of coding is important to design an efficient and reliable code."

const heading3 = "WEB & ANDROID";
const content3 = "Web Dev and Android Dev are the current aspects of the industry as more and more companies are moving towards tech."

const heading4 = "ALGORITHM DESIGN";
const content4 = "Re-designing complex algorithms in a simpler way is important for learning their implementation."

const heading5 = "MENTOR SUPPORT";
const content5 = "Providing mentorship from engineers working in top tech companies."

const heading6 = "INDUSTRY READY";
const content6 = "Preparing students to do internships in the industry in early stages of their career."
...
const card = (heading,content,DisplayImage) => {
    return (
        <div className="card">
            <div className="row">
            <DisplayImage className="col-8 card-img-top svg1 offset-2" />
